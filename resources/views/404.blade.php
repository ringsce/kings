...
<head>
    ...
    <title>Page Not Found - ringsCE Dashboard</title>
    ...
    <link rel="stylesheet" href="assets/css/Nunito.css?h=21350fcbe9816cacce9abd8b6de7d50b">
    <link rel="stylesheet" href="assets/fonts/fontawesome-all.min.css?h=fbfa80fe81882dd47f8abd5cbb011b19">
</head>
    ...
    <div id="wrapper">
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>ringsCE Dashboard</span></div>
                </a>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © ringsCE Dashboard 2024</span></div>
                </div>
            </footer>
